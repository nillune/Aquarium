...
public class FinPolish() : AquariumCard(1,
    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        FinPolishPower finPolishPower = await PowerCmd.Apply<FinPolishPower>(choiceContext, cardSource.Owner.Creature, cardSource.DynamicVars["Power"].BaseValue ,
