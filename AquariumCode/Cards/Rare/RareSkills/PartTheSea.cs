    ...
    TargetType.AnyEnemy)
{
        ...
        CardPlay play)
    {
        ...
        PartTheSeaPowerLoss  partTheSeaPowerLoss = await PowerCmd.Apply<PartTheSeaPowerLoss>(play.Target, this.DynamicVars["StrengthLoss"].BaseValue, this.Owner.Creature, (CardModel) this);
