    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        (await PowerCmd.Apply<SmokeBombPower>(cardSource.Owner.Creature, cardSource.DynamicVars["Turns"].BaseValue, cardSource.Owner.Creature, (CardModel) cardSource)).SetDexterity(cardSource.DynamicVars["BombDexterity"].BaseValue);
    }
